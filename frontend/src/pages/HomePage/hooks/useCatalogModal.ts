...
export function useCatalogModal({ open, onAdded }: Args) {
  ...
  const loadCatalog = useCallback(
    async (page: number, opts?: { replace?: boolean }) => {
      ...
      } else if (catalogItemsRef.current.length > 0) {
